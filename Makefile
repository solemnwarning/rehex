...
ifdef VERSION
	...
	VERSION      := b3cd614098ba15dc035a62161757de598466630a
	LONG_VERSION := Snapshot b3cd614098ba15dc035a62161757de598466630a
endif
...
ifneq ("$(wildcard MANIFEST)","")
	...
	sed -i -e "s|\$b3cd614098ba15dc035a62161757de598466630a|b3cd614098ba15dc035a62161757de598466630a|g" rehex-$(VERSION)/Makefile
	sed -i -e "s|\$1707944365|1707944365|g" rehex-$(VERSION)/Makefile
endif
