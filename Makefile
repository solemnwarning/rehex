...
ifdef VERSION
	...
	VERSION      := 7331cd7b43d493cceba0f4f3b06148c7167a9e29
	LONG_VERSION := Snapshot 7331cd7b43d493cceba0f4f3b06148c7167a9e29
endif
...
ifneq ("$(wildcard MANIFEST)","")
	...
	sed -i -e "s|\$7331cd7b43d493cceba0f4f3b06148c7167a9e29|7331cd7b43d493cceba0f4f3b06148c7167a9e29|g" rehex-$(VERSION)/Makefile
	sed -i -e "s|\$1651242246|1651242246|g" rehex-$(VERSION)/Makefile
endif
