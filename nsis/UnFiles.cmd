...
@rem HACK: Change directory to the root of the rehex tree, if this script is invoked with a path
@rem like ..\foo, then the path mangling below breaks, we instead invoke it with paths relative to
@rem the project root directory rather than the working directory.
cd ..
