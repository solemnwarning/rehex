		...
		public:
			...
			T GetValue()
			{
				switch(base)
				{
					case BaseHint::AUTO_FORCE:
					case BaseHint::AUTO:
						return textbox->GetNumericValue(min_value, max_value, rel_base, 0);
						
					case BaseHint::DEC:
						return textbox->GetNumericValue(min_value, max_value, rel_base, 10);
						
					case BaseHint::HEX:
						return textbox->GetNumericValue(min_value, max_value, rel_base, 16);
						
					case BaseHint::OCT:
						return textbox->GetNumericValue(min_value, max_value, rel_base, 8);
				}
