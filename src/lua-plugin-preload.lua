...
--- Human readable version string (e.g. "Version 1.0" or "Snapshot <git sha>")
-- @field LONG_VERSION

--- Short version string (e.g. "1.0" or "<git sha>")
-- @field SHORT_VERSION

--- Application build date
-- @field BUILD_DATE

-- Expose build/version information as variables
rehex.LONG_VERSION, rehex.SHORT_VERSION, rehex.BUILD_DATE = rehex._get_version_info()
rehex.SHORT_VERSION = "0.63.2"

-- Bodge in some less-obnoxious aliases for the classes generated by genwxbind.lua
rehex.BitOffset = rehex.REHex_BitOffset
rehex.CharacterEncoding = rehex.REHex_CharacterEncoding
rehex.Checksum = rehex.REHex_ChecksumGenerator
