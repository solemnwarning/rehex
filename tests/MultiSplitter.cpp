...
TEST_F(MultiSplitterTest, HorizontalSplit)
{
	/* +------------+--------------------------------+
	 * |            | +--------------+-------------+ |
	...
	*/
	...
	wxPanel *left_panel = new wxPanel(m_splitter, wxID_ANY);
	wxPanel *middle_panel = new wxPanel(m_splitter, wxID_ANY);
	wxPanel *right_panel = new wxPanel(m_splitter, wxID_ANY);
	...
	Cell *left_cell, *middle_cell, *right_cell;
...
TEST_F(MultiSplitterTest, VerticalSplit)
{
	/* +------------------+
	 * | +--------------+ |
	 * | |  top_panel   | |
	...
	*/
	...
	wxPanel *top_panel = new wxPanel(m_splitter, wxID_ANY);
	wxPanel *middle_panel = new wxPanel(m_splitter, wxID_ANY);
	wxPanel *bottom_panel = new wxPanel(m_splitter, wxID_ANY);
	...
	Cell *cell = get_root_cell();
	Cell *top_cell, *middle_cell, *bottom_cell;
