...
int main(int argc, char **argv)
{
	...
	*/
	
	{
		...
		NestedOffsetLengthMap_data_inserted(map, 0, 4);
	...
	
	{
		NestedOffsetLengthMap<int> map;
		NestedOffsetLengthMap_set(map, 10, 0, 0);
		NestedOffsetLengthMap_data_inserted(map, 6, 4);
	...
	
	{
		NestedOffsetLengthMap<int> map;
		NestedOffsetLengthMap_set(map, 10, 0, 0);
		NestedOffsetLengthMap_data_inserted(map, 10, 1);
	...
	
	{
		NestedOffsetLengthMap<int> map;
		NestedOffsetLengthMap_set(map, 10, 0, 0);
		NestedOffsetLengthMap_data_inserted(map, 11, 1);
	...
	
	{
		NestedOffsetLengthMap<int> map;
		NestedOffsetLengthMap_set(map, 10, 8, 0);
		NestedOffsetLengthMap_data_inserted(map, 11, 4);
	...
	
	{
		NestedOffsetLengthMap<int> map;
		NestedOffsetLengthMap_set(map, 10, 8, 0);
		NestedOffsetLengthMap_data_inserted(map, 17, 4);
	...
	
	{
		NestedOffsetLengthMap<int> map;
		NestedOffsetLengthMap_set(map, 10, 8, 0);
		NestedOffsetLengthMap_data_inserted(map, 18, 1);
	...
	*/
	
	{
		NestedOffsetLengthMap<int> map;
		NestedOffsetLengthMap_set(map, 10, 0, 0);
		NestedOffsetLengthMap_data_erased(map, 0, 4);
	...
	
	{
		NestedOffsetLengthMap<int> map;
		NestedOffsetLengthMap_set(map, 10, 0, 0);
		NestedOffsetLengthMap_data_erased(map, 6, 4);
	...
	
	{
		NestedOffsetLengthMap<int> map;
		NestedOffsetLengthMap_set(map, 10, 0, 0);
		NestedOffsetLengthMap_data_erased(map, 10, 1);
	...
	
	{
		NestedOffsetLengthMap<int> map;
		NestedOffsetLengthMap_set(map, 10, 0, 0);
		NestedOffsetLengthMap_data_erased(map, 4, 20);
	...
	
	{
		NestedOffsetLengthMap<int> map;
		NestedOffsetLengthMap_set(map, 10, 0, 0);
		NestedOffsetLengthMap_data_erased(map, 11, 4);
	...
	
	{
		NestedOffsetLengthMap<int> map;
		NestedOffsetLengthMap_set(map, 10, 8, 0);
		NestedOffsetLengthMap_data_erased(map, 10, 2);
	...
	
	{
		NestedOffsetLengthMap<int> map;
		NestedOffsetLengthMap_set(map, 10, 8, 0);
		NestedOffsetLengthMap_data_erased(map, 16, 2);
	...
	
	{
		NestedOffsetLengthMap<int> map;
		NestedOffsetLengthMap_set(map, 10, 8, 0);
		NestedOffsetLengthMap_data_erased(map, 13, 2);
	...
	
	{
		NestedOffsetLengthMap<int> map;
		NestedOffsetLengthMap_set(map, 10, 8, 0);
		NestedOffsetLengthMap_data_erased(map, 10, 8);
	...
	
	{
		NestedOffsetLengthMap<int> map;
		NestedOffsetLengthMap_set(map, 10, 8, 0);
		NestedOffsetLengthMap_data_erased(map, 8, 6);
	...
	
	{
		NestedOffsetLengthMap<int> map;
		NestedOffsetLengthMap_set(map, 10, 8, 0);
		NestedOffsetLengthMap_data_erased(map, 16, 6);
	...
	
	{
		NestedOffsetLengthMap<int> map;
		NestedOffsetLengthMap_set(map, 10, 8, 0);
		NestedOffsetLengthMap_data_erased(map, 18, 4);
