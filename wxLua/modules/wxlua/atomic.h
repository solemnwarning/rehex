...
// This file is copied verbatim from 2.9.4's wxWidgets/include/wx/atomic.h
// If compiled against 2.9.x we will use their copy, otherwise we use this one.
// It is provided for backwards compatibility with 2.8.x and is needed by
// wxLuaSharedPtr in wxlua/sharedptr.h

#ifndef _WXLUA_ATOMIC_H_
#define _WXLUA_ATOMIC_H_
